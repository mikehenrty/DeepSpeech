...
# The decay that's used in the batch normalization layers
decay = float(os.environ.get('ds_decay', 0.99))

# The size of the convolution kernels
kernel_size = int(os.environ.get('ds_conv_kernel_size', 11))

# The stride of the convolution kernels
stride = int(os.environ.get('ds_stride', 2))

# The number of recurrent layers
n_recurrent_layers = int(os.environ.get('ds_n_recurrent_layers', 5))
...
def create_execution_context(set_name):
    ...
    with graph.as_default():
        ...
        tower_results = get_tower_results(data_set, optimizer=optimizer, is_training=tf.placeholder(tf.bool, name="is_training"))
